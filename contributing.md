# Welcome to BCIT Design & Development (BCIT-DDC) docs contributing guide <!-- omit in toc -->
...
Now that you are part of the BCIT-DDC docs community, see how else you can [contribute to the docs](/contributing/types-of-contributions.md).
